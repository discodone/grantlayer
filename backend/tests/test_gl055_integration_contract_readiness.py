...
class TestGL055IntegrationContractReadiness(unittest.TestCase):
    ...
    EXPECTED_OPENAPI_PATHS = [
        ...
        "/grant-executions",
        "/grant-executions/{id}",
        "/grants/{id}/executions",
        "/audit-events",
        "/evidence/executions/{id}",
        "/evidence/executions/{id}/export",
        "/evidence/executions/{id}/verify",
        "/provenance/executions/{executionId}/summary",
    ...
    KNOWN_LEGACY_PATHS = [
        "/decision-provenance/v1/build",
        "/provenance-summary/v2/build",
