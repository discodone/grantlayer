...
class TestAuditorReportAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from backend.src.models import GrantExecution, Grant, GrantRequest
        from backend.src.grants import create_grant
        from backend.src.grant_requests import create_grant_request
    ...
    def test_response_contains_grant_request_when_request_exists(self):
        ...
        from backend.src.db import execute
        execute(
